...
?>
<?php if ($meine_zahlen == '') { ?>
<form action="/ges_loteria.php" method="post" accept-charset="utf-8">
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	$tipper_liste .= '<a href="/equipo.php?id='.$sql3['team'].'">'.$sql3['name'].'</a>, ';
}
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<li><a href="/equipo.php?id='.$sql3['team'].'">'.$sql3['name'].'</a> ('.__('%d Richtige', $sql3['richtige']).') &raquo; '.number_format($sql3['summe'], 0, ',', '.').' €</li>';
