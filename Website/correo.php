...
if ($sql3['von'] != CONFIG_OFFICIAL_USER) {
	echo '<strong><a href="/escribir_correo.php?id='.$sql3['von'].'&amp;betreff='.urlencode($temp).'&amp;in_reply_to='.$sql3['ids'].'">'._('Antworten').'</a> | <a href="/escribir_correo.php?id='.$sql3['von'].'">'._('Neue Nachricht').'</a></strong>';
}
echo '</p>';
if ($sql3['in_reply_to'] != '') {
