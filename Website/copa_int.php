...
for ($i = 1; $i <= 6; $i++) {
	...
	foreach ($spielliste as $spiel) {
		$tmp_liga_cache .= '<tr><td>['.substr((isset($ligaID2ligaName[$team2liga[$spiel['team1']]]) ? $ligaID2ligaName[$team2liga[$spiel['team1']]] : ' '), -1).'] <a href="/equipo.php?id='.$team_ids[$spiel['team1']].'">'.$spiel['team1'].'</a></td><td>['.substr((isset($ligaID2ligaName[$team2liga[$spiel['team2']]]) ? $ligaID2ligaName[$team2liga[$spiel['team2']]] : ' '), -1).'] <a href="/equipo.php?id='.$team_ids[$spiel['team2']].'">'.$spiel['team2'].'</a></td><td>'.$spiel['ergebnis'].'</td></tr>';
	}
