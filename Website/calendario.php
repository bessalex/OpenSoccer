...
$standardLink = '<a href="/calendario.php?team='.$chosenTeamID.'&amp;typ=';
...
echo ' <a href="/equipo.php?id='.$chosenTeamID.'" class="pagenava">'._('Zum Teamprofil').'</a>';
echo '</p>';
// TYPEN FILTER ENDE
?>
<table>
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<a href="/equipo.php?id='.$sql6.'">'.$gegner.'</a></td><td class="link"><a href="/informe_partido.php?id='.$sql3['id'].'">'.$ergebnis_live.' '.$zusatz.'</a></td>';
	echo '</tr>';
