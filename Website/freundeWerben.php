...
<p style="display:block; width:360px; margin:0 auto; padding:2px 4px; background-color:#00f; color:#fff;"><a target="_blank" style="color:#fff;" href="<?php echo getBaseURL(); ?>/?r=<?php echo $cookie_id; ?>"><?php echo CONFIG_SITE_DOMAIN; ?>/?r=<?php echo $cookie_id; ?></a></p>
<p>
    <a target="_blank" title="Facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(getBaseURL().'/?r='.$cookie_id); ?>">
        <img alt="Facebook" src="/images/brands/facebook-32.png" width="32" />
    </a>
    <a target="_blank" title="Twitter" href="https://twitter.com/share?url=<?php echo urlencode(getBaseURL().'/?r='.$cookie_id); ?>">
        <img alt="Twitter" src="/images/brands/twitter-32.png" width="32" />
    </a>
    <a target="_blank" title="Google Plus" href="https://plus.google.com/share?url=<?php echo urlencode(getBaseURL().'/?r='.$cookie_id); ?>">
