...
<p><?php echo __('Hast Du die %s des Spiels gelesen? Pro Person ist nur 1 Account erlaubt! Andere Personen dürfen natürlich vom selben Internetanschluss aus spielen, werden jedoch vom System registriert.', '<a href="/reglas.php#regeln">'._('Nutzungsregeln').'</a>');?></p>
...
<p style="text-align:center"><?php echo __('Möchtest Du %s?', '<a href="/configuracion.php">'._('Deinen Account löschen').'</a>'); ?></p>
<?php include 'zz3.php'; ?>
