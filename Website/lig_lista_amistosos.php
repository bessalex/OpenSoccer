...
<form action="/lig_lista_amistosos.php" method="get" accept-charset="utf-8">
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td>'.date('d.m.Y', $sql3['datum']).'</td><td>'.$sql3['team1'].'</td><td>'.$sql3['team2'].'</td><td class="link"><a href="/informe_partido.php?id='.$sql3['id'].'">'.$ergebnis_live.'</a></td>';
	echo '</tr>';
	$counter++;
}
?>
