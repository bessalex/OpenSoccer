...
<p><?php echo __('Hier fehlt ein Städtename, den Du gerne dabei hättest? Dann %s, vielleicht kommt er dann dazu!', '<a href="/quien_esta_en_linea.php#teamList">'._('sag uns Bescheid').'</a>'); ?></p>
...
?>
<form action="cambioNombre.php<?php if ($cookie_teamname != $showTeamName) { echo '?team='.urlencode($showTeam); } ?>" method="post" accept-charset="utf-8">
