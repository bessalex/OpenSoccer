...
<p><?php echo _('Trage Deinen gewünschten Namen in das Textfeld unten ein und klicke anschließend auf &quot;Fertig&quot;.'); ?> <?php echo __('Bitte halte Dich bei der Wahl Deines Namens aber an %s.', '<a href="/reglas.php" onclick="window.open(\'/reglas.php\'); return false">'._('diese Regeln').'</a>'); ?></p>
<?php
if (substr($_SESSION['username'], 0, 3) != 'BP_') {
...
?>
<form action="/bp_elegir_usuario.php" method="post" accept-charset="utf-8">
