...
foreach ($spieltypenMoeglich as $spieltypSingle) {
	echo '<a href="/tactica.php?spieltypTaktik='.$spieltypSingle.'" class="pagenava'; if ($spieltypTaktik == $spieltypSingle) { echo ' aktiv'; } echo '">'.$spieltypSingle.'</a>&nbsp;';
}
echo '</p>';
// SPIELTYP ENDE
?>
...
?>
<form action="/tactica.php?spieltypTaktik=<?php echo $spieltypTaktik; ?>" method="POST" accept-charset="utf-8">
<p>
