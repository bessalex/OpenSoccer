...
?>
<p style="text-align:right;"><a class="pagenava aktiv" href="/bandeja_entrada.php"><?php echo _('Posteingang'); ?></a> <a class="pagenava" href="/bandeja_salida.php"><?php echo _('Postausgang'); ?></a></p>
<form action="/bandeja_entrada.php" name="checkBoxForm" method="post" accept-charset="utf-8">
<table>
<thead>
<tr class="odd">
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td class="link"><a href="/correo.php?id='.$sql3['ids'].'">'.$sql3['titel'].'</a></td>';
