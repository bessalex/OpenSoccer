...
?>
<form action="/observacion.php" name="checkBoxForm" method="post" accept-charset="utf-8">
<table>
<thead>
<tr class="odd">
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td class="link"><a href="/jugador.php?id='.$sql3['spieler_id'].'">'.$sql3['spieler_name'].'</a></td><td>';
	if ($sql3['transfermarkt'] == 0) { echo _('Unverkäuflich'); }
	elseif ($sql3['transfermarkt'] == 1) { echo '<a href="/subasta_mercado.php?id='.$sql3['spieler_id'].'">'._('Zum Verkauf').'</a>'; }
	elseif ($sql3['transfermarkt'] > 999998) { echo '<a href="/jugador.php?id='.$sql3['spieler_id'].'">'._('Zur Leihgabe').'</a>'; }
	echo '</td>';
