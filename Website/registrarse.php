...
?>
<form method="post" action="/registro.php" accept-charset="utf-8" class="imtext">
...
<p><?php echo __('Die %1$s und die %2$s des Spiels habe ich gelesen und ich akzeptiere diese.', '<a target="_blank" href="/reglas.php#datenschutz">'._('Datenschutzrichtlinien').'</a>', '<a target="_blank" href="/reglas.php#regeln">'._('Regeln').'</a>'); ?></p>
