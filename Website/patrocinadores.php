...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<a href="/patrocinadores.php?id='.$sql3['id'].'" onclick="return confirm(\''._('Bist Du sicher?').'\')">'._('Abschließen').'</a></td></tr>';
...
<form action="/patrocinadores.php" method="post" accept-charset="utf-8">
