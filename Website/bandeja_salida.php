...
?>
<p style="text-align:right;"><a class="pagenava" href="/bandeja_entrada.php"><?php echo _('Posteingang'); ?></a> <a class="pagenava aktiv" href="/bandeja_salida.php"><?php echo _('Postausgang'); ?></a></p>
<form action="/bandeja_salida.php" name="checkBoxForm" method="post" accept-charset="utf-8">
<table>
<thead>
<tr class="odd">
