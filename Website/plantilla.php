...
?>
<form action="/plantilla.php" method="post" accept-charset="utf-8">
<table>
<thead>
<tr class="odd">
<th scope="col">&nbsp;</th>
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td>'.$sql3['position'].'</td><td>'.$transferstatus.'</td><td class="link"><a href="/jugador.php?id='.$sql3['ids'].'">'.$sql3['vorname'].' '.$sql3['nachname'].'</a></td><td>'.floor($sql3['wiealt']/365).'</td><td>'.number_format($sql3['staerke'], 1, ',', '.').' <span style="color:#999">('.number_format($schaetzungVomScout, 1, ',', '.').')</span></td>';
...
echo '<form action="/plantilla.php" method="post" accept-charset="utf-8">';
