...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td class="link"><a href="/lig_tabla.php?liga='.$sql3['newLiga2'].'">'; if (isset($ligaIDToLand[$sql3['newLiga2']])) { echo $ligaIDToLand[$sql3['newLiga2']]; } else { echo '?'; } echo '</a></td>';
	echo '<td class="link"><a href="/lig_tabla.php?liga='.$sql3['newLiga1'].'">'; if (isset($ligaIDToLand[$sql3['newLiga1']])) { echo $ligaIDToLand[$sql3['newLiga1']]; } else { echo '?'; } echo '</a></td>';
	echo '</tr>';
	$counter++;
}
?>
