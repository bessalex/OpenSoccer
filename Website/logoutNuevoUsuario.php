...
if (isset($_POST['logoutOrNot'])) {
	...
	switch ($decisionValue) {
		...
		case _('Ich habe keine Lust mehr - Account löschen!'): header('Location: /configuracion.php#accDel'); break;
...
<form action="/logoutNuevoUsuario.php" method="post" accept-charset="utf-8">
