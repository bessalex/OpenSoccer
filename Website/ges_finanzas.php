...
<tr class="odd"><?php echo showSymbolIcon('sponsor'); ?><td class="link"><a href="/patrocinadores.php"><?php echo _('Sponsor'); ?> <sup>2)</sup></a></td><td style="text-align:right"><?php echo showKontostand($sponsor_einkommen).' €'; ?></td><td style="text-align:right">0 €</td></tr>
<tr><?php echo showSymbolIcon('spieler'); ?><td class="link"><a href="/contratos.php"><?php echo _('Spielergehälter'); ?> <sup>2)</sup></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($gehalt3, 0, ',', '.'); ?> €</td></tr>
<tr class="odd"><?php echo showSymbolIcon('personal'); ?><td class="link"><a href="/ges_personal.php"><?php echo _('Jugendtrainer'); ?> <sup>2)</sup></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($ausgaben_jugendtrainer, 0, ',', '.'); ?> €</td></tr>
<tr><?php echo showSymbolIcon('personal'); ?><td class="link"><a href="/ges_personal.php"><?php echo _('Fanbetreuer'); ?> <sup>2)</sup></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($ausgaben_fanbetreuer, 0, ',', '.'); ?> €</td></tr>
<tr class="odd"><?php echo showSymbolIcon('personal'); ?><td class="link"><a href="/ges_personal.php"><?php echo _('Scout'); ?> <sup>2)</sup></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($ausgaben_scout, 0, ',', '.'); ?> €</td></tr>
<tr><?php echo showSymbolIcon('personal'); ?><td class="link"><a href="/ges_personal.php"><?php echo _('Fitness-Trainer'); ?></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($fitnesstrainer3, 0, ',', '.'); ?> €</td></tr>
<tr class="odd"><?php echo showSymbolIcon('personal'); ?><td class="link"><a href="/ges_personal.php"><?php echo _('Physiotherapeut'); ?></a></td><td style="text-align:right">0 €</td><td style="text-align:right"><?php echo number_format($physiotherapeut, 0, ',', '.'); ?> €</td></tr>
<tr><?php echo showSymbolIcon('transfers'); ?><td class="link"><a href="/lig_transferencias.php?team=<?php echo $cookie_team; ?>"><?php echo _('Transfers'); ?></a></td><td style="text-align:right"><?php echo number_format($einnahmen_transfers, 0, ',', '.'); ?> €</td><td style="text-align:right"><?php echo number_format($ausgaben_transfers, 0, ',', '.'); ?> €</td></tr>
...
<tr><?php echo showSymbolIcon('stadion'); ?><td class="link"><a href="/ges_estadio.php"><?php echo _('Stadion'); ?> <sup>2)</sup></a></td><td style="text-align:right"><?php echo number_format($einnahmen_stadion, 0, ',', '.'); ?> €</td><td style="text-align:right"><?php echo number_format($ausgaben_stadion, 0, ',', '.'); ?> €</td></tr>
<tr class="odd"><?php echo showSymbolIcon('transfers'); ?><td class="link"><a href="/cesiones.php"><?php echo _('Leihprämien'); ?> <sup>2)</sup></a></td><td style="text-align:right"><?php echo number_format($leihPraemien_ein, 0, ',', '.'); ?> €</td><td style="text-align:right"><?php echo number_format($leihPraemien_aus, 0, ',', '.'); ?> €</td></tr>
