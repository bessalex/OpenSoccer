...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	$formulierung = 'Der Jugendspieler <a href="/jugador.php?id='.$rein3a.'">'.$getmanager4.'</a> scheint großes Potenzial zu haben. Er hat deshalb einen Profivertrag für Deine erste Mannschaft bekommen.';
