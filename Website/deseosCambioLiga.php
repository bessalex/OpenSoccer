...
echo '<p style="text-align:right"><a href="/cambioLiga.php" class="pagenava">'._('Liga tauschen').'</a></p>';
echo '<form action="/deseosCambioLiga.php" method="post" accept-charset="utf-8">';
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td class="link"><a href="/equipo.php?id='.$sql3['teamID'].'">'.$sql3['teamName'].'</a></td>';
