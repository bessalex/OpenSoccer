...
while ($a3 = mysql_fetch_assoc($a2)) {
	...
	if ($a3['wiealt'] >= 11315) { // Spieler ab 31 werden schwaecher
		...
		$formulierung .= 'Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat sich wegen seines Alters um '.number_format($minus, 1, ',', '.').' Stärkepunkte verschlechtert.';
		...
		if ($a3['leiher'] != 'keiner') {
			$formulierung = 'Dein verliehener Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat sich wegen seines Alters um '.number_format($minus, 1, ',', '.').' Stärkepunkte verschlechtert.';
		...
		if ($a3['staerke'] == $a3['talent']) {
			...
			$formulierung = 'Dein ';
			if ($a3['leiher'] != 'keiner') { $formulierung .= 'ausgeliehener '; }
			$formulierung .= 'Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat seinen Höhepunkt erreicht und entwickelt sich nicht mehr weiter.';
			$sql7 = "INSERT INTO ".$prefix."protokoll (team, text, typ, zeit) VALUES ('".$a3['team']."', '".$formulierung."', 'Spieler', '".time()."')";
			$sql8 = mysql_query($sql7);
			$entwLog1 = "INSERT INTO ".$prefix."spielerEntwicklung (team, spieler, zeit, staerkeNeu, staerkeAlt) VALUES ('".$a3['team']."', '".$a3['ids']."', ".time().", ".$neu.", ".$a3['staerke'].")";
			$entwLog2 = mysql_query($entwLog1);
			if ($a3['leiher'] != 'keiner') {
				$formulierung = 'Dein verliehener Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat seinen Höhepunkt erreicht und entwickelt sich nicht mehr weiter.';
				$sql7 = "INSERT INTO ".$prefix."protokoll (team, text, typ, zeit) VALUES ('".$a3['leiher']."', '".$formulierung."', 'Spieler', '".time()."')";
				$sql8 = mysql_query($sql7);
				$entwLog1 = "INSERT INTO ".$prefix."spielerEntwicklung (team, spieler, zeit, staerkeNeu, staerkeAlt) VALUES ('".$a3['leiher']."', '".$a3['ids']."', ".time().", ".$neu.", ".$a3['staerke'].")";
				$entwLog2 = mysql_query($entwLog1);
			...
			$formulierung = 'Dein ';
			if ($a3['leiher'] != 'keiner') { $formulierung .= 'ausgeliehener '; }
			$formulierung .= 'Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat sich durch Spielpraxis um '.number_format($plus, 1, ',', '.').' Stärkepunkte verbessert.';
			$sql7 = "INSERT INTO ".$prefix."protokoll (team, text, typ, zeit) VALUES ('".$a3['team']."', '".$formulierung."', 'Spieler', '".time()."')";
			$sql8 = mysql_query($sql7);
			$entwLog1 = "INSERT INTO ".$prefix."spielerEntwicklung (team, spieler, zeit, staerkeNeu, staerkeAlt) VALUES ('".$a3['team']."', '".$a3['ids']."', ".time().", ".$neu.", ".$a3['staerke'].")";
			$entwLog2 = mysql_query($entwLog1);
			if ($a3['leiher'] != 'keiner') {
				$formulierung = 'Dein verliehener Spieler <a href="/jugador.php?id='.$a3['ids'].'">'.$a3['vorname'].' '.$a3['nachname'].'</a> hat sich durch Spielpraxis um '.number_format($plus, 1, ',', '.').' Stärkepunkte verbessert.';
				$sql7 = "INSERT INTO ".$prefix."protokoll (team, text, typ, zeit) VALUES ('".$a3['leiher']."', '".$formulierung."', 'Spieler', '".time()."')";
				$sql8 = mysql_query($sql7);
				$entwLog1 = "INSERT INTO ".$prefix."spielerEntwicklung (team, spieler, zeit, staerkeNeu, staerkeAlt) VALUES ('".$a3['leiher']."', '".$a3['ids']."', ".time().", ".$neu.", ".$a3['staerke'].")";
				$entwLog2 = mysql_query($entwLog1);
